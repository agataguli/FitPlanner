...
class SampleDataInitializer() {
    companion object {
        ...
        private val sampleSports: List<Sport> = Arrays.asList(
                ...
                Sport("Piłka nożna", "https://upload.wikimedia.org/wikipedia/commons/b/b9/Football_iu_1996.jpg", 278),
        ...
        private fun importSampleSportData(context: Context, db: SQLiteDatabase) {
            ...
            this.sampleSports.forEach { sport -> DatabaseHelper.getInstance(context)!!.addSport(db, sport) }
        }
    }
